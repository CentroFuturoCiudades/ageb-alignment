from census_alignment.assets import filter, georeferencing
...
defs = Definitions(
    assets=loading_agebs_assets + loading_census_assets + loading_metropoli_assets + filtering_assets + georeferencing_assets,
    resources={
